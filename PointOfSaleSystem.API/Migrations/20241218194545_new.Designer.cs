...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PointOfSaleSystem.API.Models.Entities.GiftCardEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("fkGiftFullOrderId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PointOfSaleSystem.API.Models.Entities.TaxEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("fkTaxFullOrderId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PointOfSaleSystem.API.Models.Entities.GiftCardEntity", b =>
                {
                    ...
                    b.HasOne("PointOfSaleSystem.API.Models.Entities.FullOrderEntity", "FullOrder")
                        .WithMany("GiftCards")
                        .HasForeignKey("fkGiftFullOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PointOfSaleSystem.API.Models.Entities.TaxEntity", b =>
                {
                    ...
                    b.HasOne("PointOfSaleSystem.API.Models.Entities.FullOrderEntity", "FullOrder")
                        .WithMany("Taxes")
                        .HasForeignKey("fkTaxFullOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
